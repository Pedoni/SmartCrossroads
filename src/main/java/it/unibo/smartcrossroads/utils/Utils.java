...
public class Utils {
    ...
    public static void calculatePoints(int h, int w) {
        ...
        map.put("s6b", new LinkedPoint(w * 2 / 3 + Constants.ROAD_WIDTH / 2, h * 2 / 3 - Constants.ROAD_WIDTH / 4,
                List.of("e7b", "c6b", "c7b")));
        map.put("s7a", new LinkedPoint(w * 2 / 3 + Constants.ROAD_WIDTH / 4, h, List.of("s7b")));
        map.put("s7b", new LinkedPoint(w * 2 / 3 + Constants.ROAD_WIDTH / 4, h * 2 / 3 + Constants.ROAD_WIDTH / 2,
                List.of("e6b", "c6b", "c7b")));
        ...
        map.put("e1b",
                new LinkedPoint(w / 3 - Constants.ROAD_WIDTH / 2, h / 3 - Constants.ROAD_WIDTH / 4, List.of("e1a")));
        ...
        map.put("e3b",
                new LinkedPoint(w / 3 + Constants.ROAD_WIDTH / 4, h / 3 - Constants.ROAD_WIDTH / 2, List.of("e3a")));
        ...
        map.put("e6b", new LinkedPoint(w * 2 / 3 + Constants.ROAD_WIDTH / 2, h * 2 / 3 + Constants.ROAD_WIDTH / 4,
                List.of("e6a")));
        map.put("e7a", new LinkedPoint(w * 2 / 3 - Constants.ROAD_WIDTH / 4, h, List.of()));
        map.put("e7b", new LinkedPoint(w * 2 / 3 - Constants.ROAD_WIDTH / 4, h * 2 / 3 + Constants.ROAD_WIDTH / 2,
                List.of("e7a")));
        ...
        map.put("c1a",
                new LinkedPoint(w / 3 - Constants.ROAD_WIDTH / 4, h / 3 + Constants.ROAD_WIDTH / 2, List.of("c1b")));
        ...
        map.put("c3b", new LinkedPoint(w * 2 / 3 - Constants.ROAD_WIDTH / 2, h / 3 - Constants.ROAD_WIDTH / 4,
                List.of("c3a")));
        map.put("c4a",
                new LinkedPoint(w / 3 + Constants.ROAD_WIDTH / 2, h / 3 + Constants.ROAD_WIDTH / 4, List.of("c4b")));
        ...
        map.put("c5a", new LinkedPoint(w * 2 / 3 - Constants.ROAD_WIDTH / 4, h / 3 + Constants.ROAD_WIDTH / 2,
                List.of("c5b")));
        map.put("c5b", new LinkedPoint(w * 2 / 3 - Constants.ROAD_WIDTH / 4, h * 2 / 3 - Constants.ROAD_WIDTH / 2,
                List.of("e6b", "e7b", "c7b")));
        map.put("c6a", new LinkedPoint(w * 2 / 3 + Constants.ROAD_WIDTH / 4, h / 3 + Constants.ROAD_WIDTH / 2,
                List.of("e4b", "e5b", "c3b")));
        map.put("c6b", new LinkedPoint(w * 2 / 3 + Constants.ROAD_WIDTH / 4, h * 2 / 3 - Constants.ROAD_WIDTH / 2,
                List.of("c6a")));
        map.put("c7a", new LinkedPoint(w / 3 + Constants.ROAD_WIDTH / 2, h * 2 / 3 - Constants.ROAD_WIDTH / 4,
                List.of("e2b", "e8b", "c2b")));
        map.put("c7b", new LinkedPoint(w * 2 / 3 - Constants.ROAD_WIDTH / 2, h * 2 / 3 - Constants.ROAD_WIDTH / 4,
                List.of("c7a")));
        map.put("c8a", new LinkedPoint(w / 3 + Constants.ROAD_WIDTH / 2, h * 2 / 3 + Constants.ROAD_WIDTH / 4,
                List.of("c8b")));
        map.put("c8b", new LinkedPoint(w * 2 / 3 - Constants.ROAD_WIDTH / 2, h * 2 / 3 + Constants.ROAD_WIDTH / 4,
                List.of("e6b", "e7b", "c6b")));
    }
